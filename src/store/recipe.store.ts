...
export const useRecipeStore = create<IRecipeState>((set) => ({
  ...
  addRecipe: async (formData: FormData) => {
    ...
    try {
      ...
      console.log("error", error);
      set({ error: "Ошибка при добавлении данных!", isLoading: false });
  ...
  updateRecipe: async (id: string, formData: FormData) => {
    ...
    try {
      ...
      console.log("error", error);
      set({ error: "Ошибка при обновлении данных!", isLoading: false });
  ...
  removeRecipe: async (id: string) => {
    ...
    try {
      ...
      console.log("error", error);
      set({ error: "Ошибка при удалении данных!", isLoading: false });
    }
  },
}));
